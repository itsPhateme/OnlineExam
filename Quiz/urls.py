...
urlpatterns = [
    ...
    path('logout/', views.user_logout, name='logout'), # Changed to use custom view if needed or built-in
    ...
    path('student-exam/<int:student_exam_id>/grade/', views.grade_student_answers, name='grade_student_answers'),
]
