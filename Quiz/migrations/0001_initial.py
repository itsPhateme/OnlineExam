# Generated by Django 4.2.26 on 2025-11-07 16:15
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('question_type', models.CharField(choices=[('short', 'Short Answer'), ('long', 'Long Answer'), ('mcq', 'Multiple Choice'), ('file', 'File Upload')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_exam', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='answers', to='Quiz.studentexam')),
            ],
        ),
    ]
